...
| 5 | `LockStore` (puerto y adaptador en memoria), mensajes de lock, presencia y UX del frontend (adquisición, heartbeat 5s, inactividad 60s, Ajuste B, chips de presencia en header; límite conocido en Nivel B: carrera de arrastre simultáneo) | En progreso |
