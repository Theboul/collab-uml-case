...
import com.example.genapp.service.ProductoService;
...
public class ProductoController {
    ...
    @PostMapping
    public Producto create(@RequestBody Map<String, Object> body) {
    ...
    @PutMapping("/{id}")
    public Producto update(@PathVariable("id") Long id, @RequestBody Map<String, Object> updates) {
    ...
    private void updateEntityFromMap(Producto entity, Map<String, Object> data) {
